    ...
    <div className="container mx-auto w-5/6 sm:w-2/3 h-full">
      ...
      <div className="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-t">
        ...
        <div className="lg:hidden w-full relative mt-2 md:mt-4">
          ...
          >
            <option className="text-sm text-gray-600 dark:text-gray-100">
              Inactive
            </option>
            <option className="text-sm text-gray-600 dark:text-gray-100">
              Inactive
        ...
        <ul className="hidden lg:flex items-center lg:mt-6 xl:mt-0">
          <li className="font-normal flex justify-center items-center py-2 px-4 rounded mr-4 xl:mr-0 xl:ml-0 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 text-sm">
            Active
          </li>
          <li className="cursor-pointer font-normal flex justify-center items-center py-2 px-4 rounded mr-4 sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-4 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm">
            Inactive
          </li>
          <li className="cursor-pointer font-normal flex justify-center items-center py-2 px-4 rounded mr-4 sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-4 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm">
            Inactive
